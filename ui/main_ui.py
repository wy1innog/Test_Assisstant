...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_dev_choice.sizePolicy().hasHeightForWidth())
        self.label_dev_choice.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(9)
        self.label_dev_choice.setFont(font)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_dev_choice.setText(_translate("MainWindow", "设备选择"))
