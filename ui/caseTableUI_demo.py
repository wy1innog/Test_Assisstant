...
# Form implementation generated from reading ui file 'caseTableUI_demo.ui'
#
...
class Ui_Testcase_table(object):
    ...
    def retranslateUi(self, Testcase_table):
        ...
        self.TreeWidget_case.topLevelItem(1).child(0).setText(1, _translate("Testcase_table", "配置"))
        self.TreeWidget_case.topLevelItem(0).child(0).setText(1, _translate("Testcase_table", "配置"))
        self.TreeWidget_case.topLevelItem(0).child(1).setText(0, _translate("Testcase_table", "主叫被挂"))
        self.TreeWidget_case.topLevelItem(0).child(1).setText(1, _translate("Testcase_table", "配置2"))
        self.TreeWidget_case.topLevelItem(0).child(2).setText(0, _translate("Testcase_table", "主叫拒接"))
        self.TreeWidget_case.topLevelItem(0).child(2).setText(1, _translate("Testcase_table", "配置3"))
        self.TreeWidget_case.topLevelItem(0).child(3).setText(0, _translate("Testcase_table", "主叫未接"))
        self.TreeWidget_case.topLevelItem(0).child(3).setText(1, _translate("Testcase_table", "配置4"))
